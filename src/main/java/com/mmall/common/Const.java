...
public class Const {
    ...
    public enum OrderStutasEnum {
        ...
        public static OrderStutasEnum codeOf(int code) {
            for (OrderStutasEnum orderStutasEnum : values()) {
                if (orderStutasEnum.getCode() == code) {
                    return orderStutasEnum;
                }
            }
